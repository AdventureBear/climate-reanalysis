...
#### 9. Resource for climate normals datasets (1991-2020)
* **US BASED** 
https://planetarycomputer.microsoft.com/dataset/noaa-climate-normals-netcdf

* **GLOBAL**
  Direct Links for Global 1991–2020 NormalsWhile "station-based" gridded normals (like those on Planetary Computer) are often limited to the U.S., NOAA PSL provides Global Reanalysis Climatologies that cover the entire Earth:Global Monthly Long-Term Means (1991–2020):NOAA PSL Monthly Mean Data Search  Look for files labeled ltm (Long Term Mean) under the NCEP/NCAR Reanalysis products.  Daily Climatology (Global):NOAA PSL Daily Climatology PageThese files provide global daily means for the 1991–2020 period in NetCDF format.Why the Planetary Computer info is "U.S. Only"The Planetary Computer hosts the Official NCEI U.S. Gridded Normals, which are generated by interpolating approximately 15,000 weather stations. Because this specific high-resolution method requires a dense surface observation network, it is strictly bound to the U.S. and its territories.  For global climate reanalysis work, scientists instead use model-based gridded normals (like ERA5 or NCEP/NCAR), which use a physics model to fill in the gaps over oceans and remote land areas where stations don't exist.  Integration Tip for your BackendSince your project uses xarray, you can use the OpenDAP links provided on the NOAA PSL pages to stream these global normals directly into your backend without having to download the massive files locally.Example URL Format for 1991–2020 Air Temp:[https://psl.noaa.gov/thredds/dodsC/Datasets/ncep.reanalysis.derived/pressure/air.mon.1991-2020.ltm.nc](https://psl.noaa.gov/thredds/dodsC/Datasets/ncep.reanalysis.derived/pressure/air.mon.1991-2020.ltm.nc)
