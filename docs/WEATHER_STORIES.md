...
- **Precipitation rate, 00z Apr 30 (the line crossing the state):**
  <http://pyreweather.org/map?variable=precip_rate&level=1000&region=Northeast&date=20250430&date_mode=single&hour=00>
- **10m wind speed, 00z Apr 30 (surface wind field):**
  <http://pyreweather.org/map?variable=wind_10m&level=1000&region=Northeast&date=20250430&date_mode=single&hour=00>
- **Surface-based CAPE, 21z (the instability the line fed on):**
  <http://pyreweather.org/map?variable=cape&level=1000&region=Northeast&date=20250429&date_mode=single&hour=21>
...
- **2m temperature anomaly, 21z Jun 29 (the fuel — historic heat):**
  <http://pyreweather.org/map?variable=temp_2m&level=1000&region=Eastern%20US&date=20120629&date_mode=single&hour=21&mode=anomaly>
- **Precipitation rate, 00z Jun 30 (the MCS over WV/VA):**
  <http://pyreweather.org/map?variable=precip_rate&level=1000&region=Eastern%20US&date=20120630&date_mode=single&hour=00>
...
- **850mb wind speed, 21z (the low-level jet feeding the storms):**
  <http://pyreweather.org/map?variable=wind_speed&level=850&region=Eastern%20US&date=19650411&date_mode=single&hour=21>
- **700mb omega anomaly, 21z (anomalous large-scale ascent):**
  <http://pyreweather.org/map?variable=omega&level=700&region=Eastern%20US&date=19650411&date_mode=single&hour=21&mode=anomaly>
...
- **PWAT anomaly, 18z (moisture surge ahead of the dryline):**
  <http://pyreweather.org/map?variable=precipitable_water&level=1000&region=Central%20Plains&date=20240521&date_mode=single&hour=18&mode=anomaly>
- **Precipitation rate, 21z (convective initiation):**
  <http://pyreweather.org/map?variable=precip_rate&level=1000&region=Central%20Plains&date=20240521&date_mode=single&hour=21>
- **Surface-based CAPE, 21z (3000–4000+ J/kg over Iowa):**
  <http://pyreweather.org/map?variable=cape&level=1000&region=Central%20Plains&date=20240521&date_mode=single&hour=21>
- **2m dewpoint, 21z (the moist axis — upper 60s °F):**
  <http://pyreweather.org/map?variable=dewpoint_2m&level=1000&region=Central%20Plains&date=20240521&date_mode=single&hour=21>
- **CIN, 18z (the weakening cap before initiation):**
  <http://pyreweather.org/map?variable=cin&level=1000&region=Central%20Plains&date=20240521&date_mode=single&hour=18>
...
- **500mb height, 12z (the deep trough):**
  <http://pyreweather.org/map?variable=height&level=500&region=Eastern%20US&date=19930313&date_mode=single&hour=12>
- **Precipitation rate, 12z:**
  <http://pyreweather.org/map?variable=precip_rate&level=1000&region=Eastern%20US&date=19930313&date_mode=single&hour=12>
- **2m temperature anomaly, 12z Mar 14 (the arctic blast behind it):**
  <http://pyreweather.org/map?variable=temp_2m&level=1000&region=Eastern%20US&date=19930314&date_mode=single&hour=12&mode=anomaly>
- **Snow depth, 12z Mar 14 (what it left behind — Appalachians buried):**
  <http://pyreweather.org/map?variable=snow_depth&level=1000&region=Eastern%20US&date=19930314&date_mode=single&hour=12>
...
- **PWAT (the moisture plume from the subtropics), 18z Feb 13:**
  <http://pyreweather.org/map?variable=precipitable_water&level=1000&region=Eastern%20Pacific&date=20250213&date_mode=single&hour=18>
- **PWAT anomaly, 18z (how loaded the atmosphere was):**
  <http://pyreweather.org/map?variable=precipitable_water&level=1000&region=Eastern%20Pacific&date=20250213&date_mode=single&hour=18&mode=anomaly>
- **850mb wind speed, 18z (the jet driving moisture onshore):**
  <http://pyreweather.org/map?variable=wind_speed&level=850&region=Eastern%20Pacific&date=20250213&date_mode=single&hour=18>
- **Precipitation rate over SoCal, 00z Feb 14:**
  <http://pyreweather.org/map?variable=precip_rate&level=1000&region=Southwest%20US&date=20250214&date_mode=single&hour=00>
...
- **850mb relative humidity, 18z Jan 8 (bone-dry downslope air):**
  <http://pyreweather.org/map?variable=rel_humidity&level=850&region=Southwest%20US&date=20250108&date_mode=single&hour=18>
...
- **PWAT anomaly, 12z Sep 27 (record moisture into the Carolinas):**
  <http://pyreweather.org/map?variable=precipitable_water&level=1000&region=Southeast%20US&date=20240927&date_mode=single&hour=12&mode=anomaly>
- **Daily-mean precipitation anomaly, Sep 27 (the flood day in one map):**
  <http://pyreweather.org/map?variable=precip_rate&level=1000&region=Southeast%20US&date=20240927&date_mode=single&hours=00,06,12,18&mode=anomaly>
...
- **10m wind speed, 12z Sep 29 (two circulations on one map):**
  <http://pyreweather.org/map?variable=wind_10m&level=1000&region=Western%20Atlantic&date=20250929&date_mode=single&hour=12>
...
- **700mb wind speed climatology, September (the AEJ ribbon):**
  <http://pyreweather.org/map?variable=wind_speed&level=700&region=Northern%20Africa&months=200009&mode=climatology>
- **700mb wind speed, 12z Sep 6 2024 (a wave disturbing the jet):**
  <http://pyreweather.org/map?variable=wind_speed&level=700&region=Northern%20Africa&date=20240906&date_mode=single&hour=12>
- **Precipitation rate, 12z Sep 6 2024 (wave convection + ITCZ):**
  <http://pyreweather.org/map?variable=precip_rate&level=1000&region=Northern%20Africa&date=20240906&date_mode=single&hour=12>
- **OLR, 12z Sep 6 2024 (cold cloud tops marching west):**
  <http://pyreweather.org/map?variable=olr&level=1000&region=Northern%20Africa&date=20240906&date_mode=single&hour=12>
...
- **PWAT climatology, January (the dry season):**
  <http://pyreweather.org/map?variable=precipitable_water&level=1000&region=India&months=200001&mode=climatology>
- **PWAT climatology, July (the switch thrown):**
  <http://pyreweather.org/map?variable=precipitable_water&level=1000&region=India&months=200007&mode=climatology>
- **850mb wind speed climatology, July (Somali jet + monsoon westerlies):**
  <http://pyreweather.org/map?variable=wind_speed&level=850&region=India&months=200007&mode=climatology>
- **200mb wind speed climatology, July (the Tropical Easterly Jet):**
  <http://pyreweather.org/map?variable=wind_speed&level=200&region=India&months=200007&mode=climatology>
- **PWAT anomaly at the 2025 onset surge, 12z May 26 2025:**
  <http://pyreweather.org/map?variable=precipitable_water&level=1000&region=India&date=20250526&date_mode=single&hour=12&mode=anomaly>
- **850mb wind monthly anomaly, June 2025 (the onset month's circulation):**
  <http://pyreweather.org/map?variable=wind_speed&level=850&region=India&months=202506&mode=anomaly>
